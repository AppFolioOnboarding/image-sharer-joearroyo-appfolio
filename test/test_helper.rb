...
module ErrorHelper
  ...
  # It fails to succeed when testing for a format validation
  # because the format detail contains two entries in its hash, unlike the others
  def self.error_for_validation(model, attribute, validation_error)
